...
function createMagicList(data,funcCallBack){
    var randomMagicList = data.randomMagicList
    ...
    */
    ...
    for(i=1;i<=listLength;i++){
        var randomMagic = randomMagicList[i]
        var magicNameList = randomMagic['magicNameList']
        var magicIconSrcList = randomMagic['magicIconSrcList']
        var magicLvList = randomMagic['magicLvList']
        var unitTypeList = randomMagic['unitTypeList']
        var abilityCooldownList = randomMagic['abilityCooldownList']
        var abilityManaCostList = randomMagic['abilityManaCostList']
        var speedList_01 = randomMagic['speedList_01']
        var speedList_02 = randomMagic['speedList_02']
        var speedList_14 = randomMagic['speedList_14']
        var maxDistanceList_03 = randomMagic['maxDistanceList_03']
        var aoeRadiusList_04 = randomMagic['aoeRadiusList_04']
        var aoeRadiusList_05 = randomMagic['aoeRadiusList_05']
        var maxDistanceList_06 = randomMagic['maxDistanceList_06']
        var maxDistanceList_15 = randomMagic['maxDistanceList_15']
        var damageList_07 = randomMagic['damageList_07']
        var damageList_08 = randomMagic['damageList_08']
        var damageList_09 = randomMagic['damageList_09']
        var maxChargesList_10 = randomMagic['maxChargesList_10']
        var chargeReplenishTimeList_11 = randomMagic['chargeReplenishTimeList_11']
        var energyList_12 = randomMagic['energyList_12']
        var energyList_13 = randomMagic['energyList_13']
        var debuffDurationList_21 = randomMagic['debuffDurationList_21']
        var beatBackDistanceList_22 = randomMagic['beatBackDistanceList_22']
        var debuffDurationList_23 = randomMagic['debuffDurationList_23']
        var aoeDurationList_24 = randomMagic['aoeDurationList_24']
        var debuffDurationList_25 = randomMagic['debuffDurationList_25']
        var debuffDurationList_26 = randomMagic['debuffDurationList_26']
        var stunDebuffDurationList_27 = randomMagic['stunDebuffDurationList_27']
        var sleepDebuffDurationList_28 = randomMagic['sleepDebuffDurationList_28']
        var aoeDurationList_29 = randomMagic['aoeDurationList_29']
        var debuffDurationList_30 = randomMagic['debuffDurationList_30']
        var aoeDurationList_31 = randomMagic['aoeDurationList_31']
        var debuffDurationList_32 = randomMagic['debuffDurationList_32']
        var debuffDurationList_33 = randomMagic['debuffDurationList_33']
        var debuffDurationList_34 = randomMagic['debuffDurationList_34']
        var aoeDurationList_35 = randomMagic['aoeDurationList_35']
        var debuffDurationList_36 = randomMagic['debuffDurationList_36']
        var GSpeedList_37 = randomMagic['GSpeedList_37']
        var aoeDurationList_38 = randomMagic['aoeDurationList_38']
        var disableTurningTimeList_39 = randomMagic['disableTurningTimeList_39']

        var boomDelayList_50 = randomMagic['boomDelayList_50']
        var visionRadiusList_51 = randomMagic['visionRadiusList_51']
        var aoeDurationList_52 = randomMagic['aoeDurationList_52']
        var debuffDurationList_53 = randomMagic['debuffDurationList_53']
        var aoeDurationList_54 = randomMagic['aoeDurationList_54']
        var visionTimeList_55 = randomMagic['visionTimeList_55']
        var debuffDelayList_56 = randomMagic['debuffDelayList_56']
        var debuffDurationList_57 = randomMagic['debuffDurationList_57']
        var searchRangeList_58 = randomMagic['searchRangeList_58']
        var doubleDamagePercentageList_59 = randomMagic['doubleDamagePercentageList_59']
        var bounsDamagePercentageList_60 = randomMagic['bounsDamagePercentageList_60']
        var sendDelayList_61 = randomMagic['sendDelayList_61']
        var chargeTimeList_62 = randomMagic['chargeTimeList_62']
        var turnRatePercentList_63 = randomMagic['turnRatePercentList_63']
        var speedPercentList_64 = randomMagic['speedPercentList_64']
        var channelTimeList_65 = randomMagic['channelTimeList_65']
        var stageDurationList_66 = randomMagic['stageDurationList_66']
        var debuffSpeedPercentList_67 = randomMagic['debuffSpeedPercentList_67']
        var bounsDamagePercentageList_68 = randomMagic['bounsDamagePercentageList_68']
        var debuffDurationList_69 = randomMagic['debuffDurationList_69']
        var aoeRadiusList_70 = randomMagic['aoeRadiusList_70']
        var damageByDistanceList_71 = randomMagic['damageByDistanceList_71']
        var diffuseSpeedList_72 = randomMagic['diffuseSpeedList_72']
        var catchRadiusList_75 = randomMagic['catchRadiusList_75']
        var windSpeedList_76 = randomMagic['windSpeedList_76']
        var windDamagePercentList_77 = randomMagic['windDamagePercentList_77']
        var boundsDamagePercentList_78 = randomMagic['boundsDamagePercentList_78']
        var windSpeedList_79 = randomMagic['windSpeedList_79']
        var boundsDamageList_80 = randomMagic['boundsDamageList_80']
        var boundsDamageCountList_81 = randomMagic['boundsDamageCountList_81']
        var shootCountList_82 = randomMagic['shootCountList_82']
        var GSpeedList_83 = randomMagic['GSpeedList_83']
        ...
        magic_img.SetImage(magicIconSrcList)
        ...
        var magicShowName = "#DOTA_Tooltip_ability_"+ magicNameList
        ...
        var magicDescribe = "#DOTA_Tooltip_ability_"+ magicNameList + "_Description"
        ...
        if (speedList_01 != 'null'){
            ...
            magicSpeed01Value.text = speedList_01 
        }

        if (speedList_02 != 'null'){
            ...
            magicSpeed02Value.text = speedList_02 
        }

        if (speedList_14 != 'null'){
            ...
            magicSpeed14Value.text = speedList_14 
        }

        if (maxDistanceList_03 != 'null'){
            ...
            magicMaxDistance03Value.text = maxDistanceList_03 
        }

        if (maxDistanceList_06 != 'null'){
            ...
            magicMaxDistance06Value.text = maxDistanceList_06 
        }

        if (maxDistanceList_15 != 'null'){
            ...
            magicMaxDistance15Value.text = maxDistanceList_15 
        }

        if (aoeRadiusList_04 != 'null'){
            ...
            magicAoeRadius04Value.text = aoeRadiusList_04 
        }

        if (aoeRadiusList_05 != 'null'){
            ...
            magicAoeRadius05Value.text = aoeRadiusList_05 
        }

        if (damageList_07 != 'null'){
            ...
            magicDamage07Value.text = damageList_07 
        }
        if (damageList_08 != 'null'){
            ...
            magicDamage08Value.text = damageList_08 
        }

        if (damageList_09 != 'null'){
            ...
            magicDamage09Value.text = damageList_09 
        }

        if (energyList_12 != 'null'){
            ...
            magicEnergy12Value.text = energyList_12 
        }

        if (energyList_13 != 'null'){
            ...
            magicEnergy13Value.text = energyList_13 
        }
        
        if (debuffDurationList_21 != 'null'){
            ...
            magicDebuffDuration21Value.text = debuffDurationList_21 + 's'
        }
        
        if (beatBackDistanceList_22 != 'null'){
            ...
            magicBeatBackDistance22Value.text = beatBackDistanceList_22
        }

        if (debuffDurationList_23 != 'null'){
            ...
            magicDebuffDuration23Value.text = debuffDurationList_23 + 's'
        }

        if (aoeDurationList_24 != 'null'){
            ...
            magicAoeDuration24Value.text = aoeDurationList_24 + 's'
        }

        if (debuffDurationList_25 != 'null'){
            ...
            magicDebuffDuration25Value.text = debuffDurationList_25 + 's'
        }

        if (debuffDurationList_26 != 'null'){
            ...
            magicDebuffDuration26Value.text = debuffDurationList_26 + 's'
        }

        if (stunDebuffDurationList_27 != 'null'){
            ...
            magicStunDebuffDuration27Value.text = stunDebuffDurationList_27 + 's'
        }

        if (sleepDebuffDurationList_28 != 'null'){
            ...
            magicSleepDebuffDuration28Value.text = sleepDebuffDurationList_28 + 's'
        }

        if (aoeDurationList_29 != 'null'){
            ...
            magicAoeDuration29Value.text = aoeDurationList_29 + 's'
        }

        if (debuffDurationList_30 != 'null'){
            ...
            magicDebuffDuration30Value.text = debuffDurationList_30 + 's'
        }

        if (aoeDurationList_31 != 'null'){
            ...
            magicAoeDuration31Value.text = aoeDurationList_31 + 's'
        }

        if (debuffDurationList_32 != 'null'){
            ...
            magicDebuffDuration32Value.text = debuffDurationList_32 + 's'
        }

        if (debuffDurationList_33 != 'null'){
            ...
            magicDebuffDuration33Value.text = debuffDurationList_33 + 's'
        }

        if (debuffDurationList_34 != 'null'){
            ...
            magicDebuffDuration34Value.text = debuffDurationList_34 + 's'
        }

        if (aoeDurationList_35 != 'null'){
            ...
            magicAoeDuration35Value.text = aoeDurationList_35 + 's'
        }

        if (debuffDurationList_36 != 'null'){
            ...
            magicDebuffDuration36Value.text = debuffDurationList_36 + 's'
        }

        if (GSpeedList_37 != 'null'){
            ...
            magicGSpeed37Value.text = GSpeedList_37
        }

        if (aoeDurationList_38 !=  'null'){
            ...
            magicAoeDuration38Value.text = aoeDurationList_38 + 's'
        }

        
        if (disableTurningTimeList_39 !=  'null'){
            var magicAoeDuration38 = $.CreatePanel('Panel', $("#magicSpecialVal1"+i),"magicAoeDuration38"+i);
            magicAoeDuration38.AddClass("magicSpecialValItem")     
            var magicAoeDuration38Title = $.CreatePanel('Label', $("#magicAoeDuration38"+i),"magicAoeDuration38Title"+i);
            magicAoeDuration38Title.AddClass("magicEffectTitle")
            ...
            var magicAoeDuration38Value = $.CreatePanel('Label', $("#magicAoeDuration38"+i),"magicAoeDuration38Value"+i);
            magicAoeDuration38Value.AddClass("magicSpecialValue")
            magicAoeDuration38Value.text = disableTurningTimeList_39 + 's'
        }
        ...
        if (maxChargesList_10 !=  'null'){
            ...
            magicMaxCharges10Value.text = maxChargesList_10 
        }

        if (chargeReplenishTimeList_11 !=  'null'){
            ...
            magicChargeReplenishTime11Value.text = chargeReplenishTimeList_11 + 's'
        }

        if (boomDelayList_50 !=  'null'){
            ...
            magicBoomDelay50Value.text = boomDelayList_50 + 's'
        }

        if (visionRadiusList_51 !=  'null'){
            ...
            magicVisionRadius51Value.text = visionRadiusList_51 * -1
        }
        
        if (aoeDurationList_52 !=  'null'){
            ...
            magicAoeDuration52Value.text = aoeDurationList_52 + 's'
        }

        if (debuffDurationList_53 !=  'null'){
            ...
            magicDebuffDuration53Value.text = debuffDurationList_53 + 's'
        }

        if (aoeDurationList_54 !=  'null'){
            ...
            magicAoeDuration54Value.text = aoeDurationList_54 + 's'
        }

        if (visionTimeList_55 !=  'null'){
            ...
            magicVisionTime55Value.text = visionTimeList_55 + 's'
        }
        
        if (debuffDelayList_56 !=  'null'){
            ...
            magicDebuffDelay56Value.text = debuffDelayList_56 + 's'
        }

        if (debuffDurationList_57 !=  'null'){
            ...
            magicDebuffDuration57Value.text = debuffDurationList_57 + 's'
        }

        if (searchRangeList_58 !=  'null'){
            ...
            magicSearchRange58Value.text = searchRangeList_58
        }

        if (doubleDamagePercentageList_59 !=  'null'){
            ...
            magicDoubleDamagePercentage59Value.text = doubleDamagePercentageList_59 + '%'
        }

        if (bounsDamagePercentageList_60 !=  'null'){
            ...
            magicBounsDamagePercentage60Value.text = bounsDamagePercentageList_60 + '%'
        }

        if (sendDelayList_61 !=  'null'){
            ...
            magicSendDelay61Value.text = sendDelayList_61 + 's'
        }

        if (chargeTimeList_62 !=  'null'){
            ...
            magicChargeTime62Value.text = chargeTimeList_62 + 's'
        }

        if (turnRatePercentList_63 !=  'null'){
            ...
            magicTurnRatePercent63Value.text = turnRatePercentList_63 * -1 + '%'
        }

        if (speedPercentList_64 !=  'null'){
            ...
            magicSpeedPercent64Value.text = speedPercentList_64 * -1 + '%'
        }

        if (channelTimeList_65 !=  'null'){
            ...
            magicChannelTime65Value.text = channelTimeList_65 + 's'
        }

        if (stageDurationList_66 !=  'null'){
            ...
            magicStageDuration66Value.text = stageDurationList_66 + 's'
        }
        
        if (debuffSpeedPercentList_67 !=  'null'){
            ...
            magicDebuffSpeedPercent67Value.text = debuffSpeedPercentList_67 *-1 + '%'
        }
        
        if (bounsDamagePercentageList_68 !=  'null'){
            ...
            magicBounsDamagePercentage68Value.text = bounsDamagePercentageList_68 + '%'
        }
        
        if (debuffDurationList_69 !=  'null'){
            ...
            magicDebuffDuration69Value.text = debuffDurationList_69 + 's'
        }
        
        if (aoeRadiusList_70 !=  'null'){
            ...
            magicAoeRadius70Value.text = aoeRadiusList_70
        }
        
        if (damageByDistanceList_71 !=  'null'){
            ...
            magicDamageByDistance71Value.text = damageByDistanceList_71
        }

        if (diffuseSpeedList_72 !=  'null'){
            ...
            magicDiffuseSpeed72Value.text = diffuseSpeedList_72
        }
        
        if (catchRadiusList_75 !=  'null'){
            ...
            magicCatchRadius75Value.text = catchRadiusList_75
        }
        
        if (windSpeedList_76 !=  'null'){
            ...
            magicWindSpeed76Value.text = windSpeedList_76
        }
        
        if (windDamagePercentList_77 !=  'null'){
            ...
            magicWindDamagePercent77Value.text = windDamagePercentList_77 + '%'
        }
        
        if (boundsDamagePercentList_78 !=  'null'){
            ...
            magicBoundsDamagePercent78Value.text = boundsDamagePercentList_78 + '%'
        }
        
        if (windSpeedList_79 !=  'null'){
            ...
            magicWindSpeed79Value.text = windSpeedList_79
        }
        
        if (boundsDamageList_80 !=  'null'){
            ...
            magicBoundsDamage80Value.text = boundsDamageList_80
        }
        
        if (boundsDamageCountList_81 !=  'null'){
            ...
            magicBoundsDamageCount81Value.text = boundsDamageCountList_81
        }
        
        if (shootCountList_82 !=  'null'){
            ...
            magicShootCount82Value.text = shootCountList_82
        }
        
        if (GSpeedList_83 !=  'null'){
            ...
            magicGSpeed83Value.text = GSpeedList_83
        }
...
function getRebuildMagicListToForgetLUATOJS(data){
    ...
    var magicIconSrcList = data.magicIconSrcList
    ...
    */
    ...
    for(i=1;i<=listLength;i++){
        ...
        var magic_img = $.CreatePanel('DOTAAbilityImage', $("#magicTopBanner"+i),"magic_img"+i);
        magic_img.AddClass("magic_img")
        //$.Msg(magicIconSrcList)
        magic_img.SetImage(magicIconSrcList[i])
        //magic_img.abilityname(magicNameList)
